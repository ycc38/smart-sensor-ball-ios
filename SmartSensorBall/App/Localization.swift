...
enum L10n {
    ...
    private static let english: [String: String] = [
        ...
        "activation_hint": "Activation is required before training and keeps cloud profile, achievements, and leaderboard sync available.",
    ...
    private static let chinese: [String: String] = [
        ...
        "activation_hint": "开始训练前需要先激活，激活后可同步云端资料、成就和排行榜。",
