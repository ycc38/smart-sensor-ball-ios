...
enum L10n {
    ...
    private static let table: [AppLanguage: [String: String]] = [
        ...
        .french: [
            ...
            "first_use_message": "Avant la première séance, ouvrez les paramètres pour scanner et connecter votre appareil Smart sensor ball.",
            "open_settings": "Ouvrir les paramètres",
            "later": "Plus tard",
            "settings": "Paramètres",
            "settings_title": "Connexion Bluetooth et langue",
            "bluetooth_connection": "Connexion Bluetooth",
            "bluetooth_hint": "Scannez d'abord un appareil SENBALL#. L'entraînement sera disponible après connexion.",
            "scan": "Scanner",
            "connect": "Connecter",
            ...
            "countdown": "Départ dans %d",
            "running": "En entraînement",
            "complete": "Entraînement terminé",
            "stopped": "Entraînement arrêté",
        ],
        .thai: [
            "first_use_title": "เชื่อมต่ออุปกรณ์บลูทูธ",
            "first_use_message": "ก่อนใช้งานครั้งแรก โปรดเปิดตั้งค่าเพื่อสแกนและเชื่อมต่ออุปกรณ์ Smart sensor ball",
            "open_settings": "ไปที่ตั้งค่า",
            "later": "ภายหลัง",
            "settings": "ตั้งค่า",
            "settings_title": "การเชื่อมต่อบลูทูธและภาษา",
            "bluetooth_connection": "การเชื่อมต่อบลูทูธ",
            ...
            "ready": "พร้อมฝึก",
            "connect_first": "โปรดเชื่อมต่ออุปกรณ์บลูทูธก่อน",
            "countdown": "เริ่มใน %d",
            "running": "กำลังฝึก",
